...
class FormAutomation:
    def __init__(self, index): #index für wiederholung
        self.name = f"Testnachname  {index} 14.11.2024 "
        ...
        self.geschlecht = random.choice(['weiblich', 'männlich']) 
        self.index = index
        #Versichertendaten
...
class Männlich:
    ...
    def thrombose_lungenembolie_2(self):
        ...
        for option_name, (x, y) in selected_options:
            ...
            py.moveTo(x, y)
            py.click()
            time.sleep(0.3)  # Slight delay between clicks if multiple options
    ...
    def reset_view_to_normal(self):
        ...
        time.sleep(0.3)  # Small delay to ensure the changes are registered
    ...
    def infektionskrankheiten(self):
        ...
        py.hotkey('ctrl', 'f')
        time.sleep(0.3)
        py.write('Besteht eine akute/chronische Infektionserkrankung wie z.B. Hepatitis, AIDS/HIV, Tbc')
        time.sleep(0.3)
        py.press("enter")
        time.sleep(0.3)
        py.press("esc")
        ...
        # Randomly select one of the given numbers
        infektionskrankheit_choice = random.choice([1, 4, 7, 10, 13])

        # Press 'tab' the number of times equal to the chosen number
        for i in range(infektionskrankheit_choice):
            py.press('tab')

        py.press("space")
        py.press('tab')

        # If 13 is chosen, write specific text; otherwise, write month and year details
        if infektionskrankheit_choice == 13:
            py.write("sonstige Details Eingaben")
        else:
            py.write(self.thrombose_monat)
            py.press('tab')
            py.write(self.thrombose_jahr)
    ...
    def chronische_krankheiten(self):
        ...
        py.hotkey('ctrl', 'f')
        time.sleep(0.3)
        py.write('Haben Sie sonst eine oder mehrere chronische Krankheiten?')
        time.sleep(0.3)
        py.press("enter")
        time.sleep(0.3)
        py.press("esc")
    ...
    def tumor_krebserkrankung(self):
        ...
        # Expanded version of go_to_text('Haben Sie eine Tumor-/Krebserkrankung in Ihrer Vorgeschichte?')
        time.sleep(0.3)
        py.hotkey('ctrl', 'f')
        time.sleep(0.3)
        py.write('Haben Sie eine Tumor-/Krebserkrankung in Ihrer Vorgeschichte?')
        time.sleep(0.3)
        py.press("enter")
        time.sleep(0.3)
        py.press("esc")
        ...
        # Randomly select one of the given numbers
        infektionskrankheit_choice = random.choice([1, 4, 7, 10, 13, 16, 19, 22])
    ...
    def gewichtsverlust_migraene(self):
        ...
        py.hotkey('ctrl', 'f')
        time.sleep(0.3)
        py.write('die letzten 6 Monaten ungewollt mehr als 5 kg')
        time.sleep(0.3)
        py.press("enter")
        time.sleep(0.3)
        py.press("esc")
        ...
        if random.randint(1, 2) == 1:
            ...
            py.press('tab')
            time.sleep(0.1)
            for choice in random.sample(range(8), random.randint(1, 8)):
        ...
        # Expanded version of go_to_text('er Hände, Füße und Lippen oder auch selten eine Schwäche der Extremitäten.')
        time.sleep(0.3)
        py.hotkey('ctrl', 'f')
        time.sleep(0.3)
        py.write('er Hände, Füße und Lippen oder auch selten eine Schwäche der Extremitäten.')
        time.sleep(0.3)
        py.press("enter")
        time.sleep(0.3)
        py.press("esc")
    ...
    def alkoholkonsum(self):
        ...
        py.hotkey('ctrl', 'f')
        time.sleep(0.3)
        py.write('Ein Ausdruck dieses Formulars ist nicht nötig. Alle Daten werden digital an uns übermittelt.')
        time.sleep(0.3)
        py.press("enter")
        time.sleep(0.3)
        py.press("esc")
...
class Weiblich:
    ...
    def thrombose_lungenembolie_3(self):
        ...
        if selected_group == 1:
            ...
            py.moveTo(x, y)
            py.click()
            time.sleep(0.3)  # Ensure the selection is registered
            self.reset_view_to_normal()
            ...
            py.press('tab')
            py.write("hi test")
            time.sleep(0.3)  # Ensure the follow-up action is processed
            self.reset_view_to_normal()
